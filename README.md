...
показывает экран первичной настройки: владелец задаёт имя, email и пароль (не короче
8 символов). Учётной записи по умолчанию нет — пароль, зашитый в поставку, знали бы все.
